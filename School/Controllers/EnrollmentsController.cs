...
{
    public class EnrollmentsController : BaisController
    {
        ...
        {
            //var enrollments = db.Enrollments.Include("Student").Include("Course");
            var students = new List<string>();
            foreach (var enroll in db.Enrollments.ToList())
            {
                students.Add(enroll.Student.FirstName + " " + enroll.Student.LastName);
            }
